...
Route::get('/admin/payroll', array('as' => '', 'uses' => function() {
	...
	if( !empty($groups) ) {
		...
		if ( strcmp(strtolower($groups->name), strtolower('Employee')) !== 0 ) {
			...
			return View::make('admin.payroll', array('dataArr' => $dataArr, 'groupName' => $dataArr['groupName'], 'employeeInfo' => $employeeInfo, 'getUserEmployee' => $getUserEmployee, 'getTimeSubmitted' => $getTimeSubmitted, 'getlists' => $getlists, 'getlistemps' => $getlistemps));
...
Route::post('/admin/payroll/saveData', array('uses' => function()
{
		...
		return View::make('admin.payrolllist', array('dataArr' => $dataArr, 'groupName' => $dataArr['groupName'], 'employeeInfo' => $employeeInfo, 'getpays' => $getpays, 'message' => $message));
