...
class TimesheetsController extends \BaseController {
	...
	public function init() {
		...
		/*
		$tempSummaries = Tempsummary::where('employee_id', $currentUserId)
							->whereIn('daydate', $dayDateArr)->get();
		
		$tempSummary = Tempsummary::where('employee_id', $currentUserId)
						  ->where('daydate', $currentDate)->first();							
		*/
		...
		return $dataArr = array( 		            
					...
					/*'tempSummaries' => $tempSummaries,
					'tempSummary' => $tempSummaries,*/
					'summaries' => $summaries,
					'summary' => $summary,
					'schedule' => $schedule,
					'holiday' => $holiday,
				...
				if ( ( !empty($timeIn1) && !empty($timeOut1) ) && 
					...
					//TIMESHEET 3.1 - EMPTY COMPUTATION =========================================================================================================
						...
						if ( !$isFlexible ) {
							...
							//GET TOTALHOURS WITH OVERTIME
							$timesheet->total_hours_3 = totalHoursWithOvertime($dateTimeFormatIn3, $dateTimeFormatOut3, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);						
					...
					//TIMESHEET 2.1 - EMPTY COMPUTATION =========================================================================================================
						...
						if ( !$isFlexible ) {
							...
							//GET TOTALHOURS WITH OVERTIME
							$timesheet->total_hours_2 = totalHoursWithOvertime($dateTimeFormatIn2, $dateTimeFormatOut2, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);						
					...
					//TIMESHEET 1.1 - WITH COMPUTATION =========================================================================================================
						...
						if ( !$isFlexible ) {
							...
							//GET TOTALHOURS WITH OVERTIME
							$timesheet->total_hours_1 = totalHoursWithOvertime($dateTimeFormatIn1, $dateTimeFormatOut1, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);						
	...
	public function timeClocking() {
		...
		/*$tempSummary = $dataArr["tempSummary"];
		$tempSummaries = $dataArr["tempSummaries"];*/
					...
					*/
					...
					if ( $timesheet->clocking_status === "clock_in_1" ) {
						...
						if ( !$isFlexible ) {
							...
							//GET TOTALHOURS WITH OVERTIME
							echo $timesheet->total_hours_1 = totalHoursWithOvertime($timesheetTimeIn, $timesheetTimeOut, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);						
					...
					if ( $timesheet->clocking_status === "clock_in_2" ) {
						...
						if ( !$isFlexible ) {
							...
							//GET TOTALHOURS WITH OVERTIME
							echo $timesheet->total_hours_2 = totalHoursWithOvertime($timesheetTimeIn, $timesheetTimeOut, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);						
					...
					if ( $timesheet->clocking_status === "clock_in_3" ) {	
						...
						if ( !$isFlexible ) {
							...
							//GET TOTALHOURS WITH OVERTIME
							echo $timesheet->total_hours_3 = totalHoursWithOvertime($timesheetTimeIn, $timesheetTimeOut, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);						
					...
					*/
					...
					if ( $timesheetYesterday->clocking_status === "clock_in_1" ) {
						...
						if ( !$isFlexible ) {
							...
							//GET TOTALHOURS WITH OVERTIME
							echo $timesheetYesterday->total_hours_1 = totalHoursWithOvertime($timesheetTimeIn, $timesheetTimeOut, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);						
					...
					if ( $timesheetYesterday->clocking_status === "clock_in_2" ) {
						...
						if ( !$isFlexible ) {
							...
							//GET TOTALHOURS WITH OVERTIME
							echo $timesheetYesterday->total_hours_2 = totalHoursWithOvertime($timesheetTimeIn, $timesheetTimeOut, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);						
					...
					if ( $timesheetYesterday->clocking_status === "clock_in_3" ) {	
						...
						if ( !$isFlexible ) {
							...
							//GET TOTALHOURS WITH OVERTIME
							echo $timesheetYesterday->total_hours_3 = totalHoursWithOvertime($timesheetTimeIn, $timesheetTimeOut, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);						
	...
	public function processTimesheetComputation($isFlexible = 0, $timesheetTimeIn, $timesheetTimeOut, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak) {
		...
		//GET TOTALHOURS WITH OVERTIME
		$totalHours = totalHoursWithOvertime($timesheetTimeIn, $timesheetTimeOut, $scheduleStartTime, $scheduleEndTime, $breakTime, $hoursPerDay, $halfOfhoursPerDay, $hasBreak);
		echo $timesheet->total_hours_1 = $totalHours;
