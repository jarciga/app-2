	        	...
	        	<div class="table-responsive">
					...
					<?php			
							foreach ($payInfos as $payInfo) 
							{
									...
									$timestamp = strtotime($payInfo->cutfrom);
									$cutoffF = date("d", $timestamp);
	
									$timestamp2 = strtotime($payInfo->cutto);
									$cutoffT = date("d", $timestamp2);
									
									//echo "cutfrom day" . $cutoffF;
									//echo "<br>cutto day" . $cutoffT;
								...
								echo "<table class='table table-striped table-hover table-list display' style='font-size: 12px; width: 100%; border: 1px solid #000000' >
									  ...
									  //if($payInfo->) 				
										...
										echo  "<td>Other Loan</td><td>&nbsp;</td></tr>
											  ...
											  <tr><td>EARNINGS</td><td>" . $payInfo->gross_pay . "</td><td>NET PAY</td><td>" . $payInfo->net_pay . "</td></tr>
