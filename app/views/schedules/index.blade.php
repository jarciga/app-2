...
@section('content')		
  ...
  <?php if( ($resourceId === "admin") || 
            ($resourceId === "admin.schedules.show.schedule.uploader") ||
            ($resourceId === "admin.schedules.show.schedule.default") ||
            ($resourceId === "admin.schedules.show.schedule.edit") ): ?>
    @include('partials.admin.schedules')
  <?php endif; ?>
