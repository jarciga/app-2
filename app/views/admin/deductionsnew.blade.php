...
<!--div class="page-container"-->
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            {{ Form::open(array('url' => '/admin/deductions/new', 'id' => 'timeClockingForm', 'class' => 'form-horizontal')) }}                
			...
			<div class="form-group">
                ...
                <div class="col-sm-3">
                {{ Form::text('cutfrom', '', array('class' => 'datepicker')) }}
                </div>
            </div>    
			...
			<div class="form-group">
                ...
                <div class="col-sm-3">
                {{ Form::text('cutto', '', array('class' => 'datepicker')) }}
                </div>	
			</div> 
            
            <br><br>
            <div class="form-group">
                {{ Form::label('cashadvance', 'Cash Advance', array('class' => 'col-sm-2 control-label')) }}           
                <div class="col-sm-3">
                {{ Form::text('cash_advance', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Cash Advance')) }}
                </div>
            </div>            

			
            <div class="form-group">           
                {{ Form::label('companyloan', 'Company Loan', array('class' => 'col-sm-2 control-label')) }}
                <div class="col-sm-3">            
                {{ Form::text('company_loan', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Company Loan')) }}            
                </div>                        
            </div>            

			
            <div class="form-group">           
                {{ Form::label('hdmfloan', 'HDMF Loan', array('class' => 'col-sm-2 control-label')) }}            
                <div class="col-sm-3">            
                {{ Form::text('hdmf_loan', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'HDMF Loan')) }}            
                </div>            
            </div>            
          
            
            <div class="form-group">           
                {{ Form::label('hmodep', 'HMO Deposit', array('class' => 'col-sm-2 control-label')) }}
                <div class="col-sm-3">            
                {{ Form::text('hmo_dep', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'HMO Deposit')) }}            
                </div>                        
            </div>            
            ...
            <div class="form-group">           
                ...
                <div class="col-sm-3">           
                {{ Form::text('sss_salary_loan', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'SSS Salary Loan')) }}            
                </div>                        
            </div>                  
            ...
            <div class="form-group">           
                ...
                <div class="col-sm-3">           
                {{ Form::text('telephone_charges', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Telephone Charges')) }}            
                </div>                        
            </div>                                       

            <div class="col-sm-offset-2 col-sm-10">
                <div class="col-sm-3">                        
                {{ Form::submit('Add Deductions', array('class' => '', 'class' => 'btn btn-primary')) }}
                </div>                                        
            </div>            
