...
<!--div class="page-container"-->
        ...
        <!--div class="row" style="padding-bottom:20px;"-->
          ...
          <div id="content" class="col-md-12" role="main">
            ...
            <h1 class="page-header">Specify the range of date for the cut-off period</h1>
 
			{{ Form::open(array('url' => '/admin/payroll/displaycutoff')) }}

				{{ Form::label('Cutoff Date From', 'Cutoff Date From') }}
				{{ Form::text('cutoff_date_from', '', array('class' => 'datepicker')) }}
				{{ Form::label('Cutoff Date To', 'Cutoff Date to') }}
				{{ Form::text('cutoff_date_to', '', array('class' => 'datepicker')) }}

			{{ Form::submit('Generate Payroll Register', array('class' => '', 'class' => 'btn btn-primary')) }}								
