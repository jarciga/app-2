...
<!--div class="page-container"-->
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            {{ Form::open(array('url' => '/admin/earnings/new', 'id' => 'timeClockingForm', 'class' => 'form-horizontal')) }}                
            ...
            <div class="form-group">           
                ...
                <div class="col-sm-3">            
                {{ Form::text('mobile_allowance', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Mobile Allowance')) }}            
                </div>            
            </div>            
            ...
            <div class="form-group">           
                ...
                <div class="col-sm-3">            
                {{ Form::text('previous_payroll', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Previous Payroll')) }}            
                </div>                        
            </div>            
            ...
            <div class="form-group">           
                ...
                <div class="col-sm-3">           
                {{ Form::text('reimbursible_allowance', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Reimbursible Allowance')) }}            
                </div>                        
            </div>                  
            ...
            <div class="form-group">           
                ...
                <div class="col-sm-3">           
                {{ Form::text('retro_payment', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Retro Payment')) }}            
                </div>                        
            </div>            
            ...
            <div class="form-group">           
                ...
                <div class="col-sm-3">           
                {{ Form::text('transportation_allowance', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Transportation Allowance')) }}            
                </div>                        
            </div>
			...
			<div class="form-group">           
                ...
                <div class="col-sm-3">           
                {{ Form::text('previous_OT_adjustment', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Previous OT Adjustment')) }}            
                </div>                        
            </div>
			...
			<div class="form-group">           
                ...
                <div class="col-sm-3">           
                {{ Form::text('previous_payroll_adjustment', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Previous Payroll Adjustment')) }}            
                </div>                        
            </div>
			...
			<div class="form-group">           
                ...
                <div class="col-sm-3">           
                {{ Form::text('retro_payment_adjustment', '', array('id' => '', 'class' => 'form-control', 'placeholder' => 'Retro Payment Adjustment')) }}            
                </div>                        
            </div>
            ...
            <div class="col-sm-offset-2 col-sm-10">
                <div class="col-sm-3">                        
                {{ Form::submit('Add Earnings', array('class' => '', 'class' => 'btn btn-primary')) }}
                </div>                                        
            </div>            
