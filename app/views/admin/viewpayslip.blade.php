...
<?php
	...
	$timestamp = strtotime($cfrom);
	$cutoffF = date("d", $timestamp);
	
	$timestamp2 = strtotime($cto);
							  ...
							  echo "<tr>
								...
								echo "<table class='table table-striped table-hover table-list display' style='font-size: 12px; width: 100%; border: 1px solid #000000' >
									  ...
									  <td style='border-right: 1px black solid; border-top: 1px black solid'>
										<table class='table table-striped table-hover table-list display' style='font-size: 12px; width: 100%; border-top: 1px black solid'>";
