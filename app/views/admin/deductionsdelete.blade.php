...
<!--div class="page-container"-->
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" style="font-size:14px; font-weight:bold;">Delete Deduction</div>
          <div class="panel-body">
            ...
            {{ Form::open(array('url' => '/admin/deductions/delete/'.$id, 'id' => '', 'class' => 'form-inline')) }}              
            {{ Form::hidden('deduction_id', $id); }}
			{{ Form::hidden('cutfrom', $empdeducInfo->cutfrom); }}
			{{ Form::hidden('cutto', $empdeducInfo->cutto); }}
