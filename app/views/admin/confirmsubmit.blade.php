...
<!--div class="page-container"-->
        ...
        <!--div class="row" style="padding-bottom:20px;"-->
          ...
          <div id="content" class="col-md-12" role="main">
            ...
            <h1 class="page-header">Submit Timesheets</h1>

        <div class="panel panel-default">
          <!-- Default panel contents -->
          <div class="panel-heading" style="font-size:14px; font-weight:bold;">Confirm Submission of Timesheets</div>
          <div class="panel-body">
            ...
            {{ Form::open(array('url' => '/admin/timesheet/submitEmpTimesheet', 'id' => '', 'class' => 'form-inline')) }}              
            {{-- Form::hidden('earning_id', $id); --}}
			{{-- Form::hidden('cutfrom', $empEarningInfo->cutfrom); --}}
			{{-- Form::hidden('cutto', $empEarningInfo->cutto); --}}
            <div class="form-group">
              <p>Are you sure you want to submit these timesheets? </p>
            </div>            
              {{ Form::submit('Submit', array('class' => 'btn btn-custom-default pull-right')) }}
            </div>            
