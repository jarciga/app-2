...
<!--div class="page-container"-->
        ...
        <!--div class="row" style="padding-bottom:20px;"-->
          ...
          <div id="content" class="col-md-12" role="main">
            ...
            <h1 class="page-header">Change Body of Email Notification</h1>
 
			{{ Form::open(array('url' => '/admin/email/emailSettings')) }}

				  {{ Form::label('Enter text of Email Notification', 'Email Notification') }} <br>
				  {{ Form::textarea('text_email', $emailInfo[0]->text_email, ['size' => '70x15']) }} <br><br>
                  
                  {{ Form::submit('Submit', array('class' => '', 'class' => 'btn btn-primary')) }}                
