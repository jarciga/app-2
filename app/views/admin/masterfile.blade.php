        ...
        <!--div class="row" style="padding-bottom:20px;"-->
          ...
          <div id="content" class="col-md-12" role="main">
            ...
            <h1 class="page-header">Employee Scheduling</h1>
			  ...
			  <div class="panel-heading" style="font-size:14px; font-weight:bold;">Employee Masterfile</div>
			  <div class="panel-body">
				...
				<li role="presentation" class="active"><a href="#listEarnings" aria-controls="listEarnings" role="tab" data-toggle="tab">List of Earnings</a></li>
				<li role="presentation"><a href="#listDeductions" aria-controls="listDeductions" role="tab" data-toggle="tab">List of Deductions</a></li>
				</ul>

					<!-- Tab panes -->
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="listEarnings">

							<div class="tabpanel-container" style="padding:10px;">
							
								<br><div><a href="{{ url('/admin/earnings/new') }}" class="">Add Earning Record</a></div><br>
								...
								<table class="table table-striped table-hover table-list display" cellspacing="0" width="100%">
								        ...
								        <thead>
								            <tr>
												...
												<th>Reimbursible Allow.</th>
												<th>Retro Payment</th>
												<th>Transportation Allow.</th>
												<th>Previous OT Adjust.</th>
												<th>Previous Payroll Adjust.</th>
												<th>Retro Payment Adjust.</th>
												<th>Action</th>
												<!--th>Previous Payroll</th-->                                                
								            </tr>
								        </thead>
								        ...
								        <tbody>            
												...
												if(!empty($earnInfos))
												{
													...
													?>
														...
														<tr>
															<td><?php echo $earn->cutfrom . ' - ' . $earn->cutto; ?></td>
															<td><?php echo $empsettingInfo->ecola; ?></td>
															<td><?php echo $empsettingInfo->deminimis; ?></td>          
															<td><?php echo $earn->mobile_allowance; ?></td>
															<td><?php echo $earn->previous_payroll; ?></td>
															<td><?php echo $earn->reimbursible_allowance; ?></td>
															<td><?php echo $earn->retro_payment; ?></td>
															<td><?php echo $earn->transportation_allowance; ?></td>
															<td><?php echo $earn->previous_OT_adjustment; ?></td>
															<td><?php echo $earn->previous_payroll_adjustment; ?></td>
															<td><?php echo $earn->retro_payment_adjustment; ?></td>
															<td><a href="{{ url('/admin/earnings/' . $earn->ID . '/edit') }}">Edit</a> | <a href="{{ url('/admin/earnings/delete/' . $earn->ID) }}">Delete</a></td>                                                
														</tr>				
									      <?php		} ?>
													</tbody>
												</table>
										  <?php		} else {?>
														<tr><td colspan="10">No earnings recorded.</td></tr>
													</tbody>
												</table>
					...
					<div role="tabpanel" class="tab-pane" id="listDeductions">
						
							<div class="tabpanel-container" style="padding:10px;">

								<br><div><a href="{{ url('/admin/deductions/new') }}" class="">Add Deductions Record</a></div><br>
								...
								<table class="table table-striped table-hover table-list display" cellspacing="0" width="100%">
								        ...
								        <tbody>            
									            ...
									            <?php
												//var_dump($earnInfos);
												if(!empty($deductionInfos))
												{
													
													foreach($deductionInfos as $deduc) 
													{
													...
													?>
														...
														<tr>
															<td><?php echo $deduc->cutfrom . ' - ' . $deduc->cutto; ?></td>
															<td><?php echo $deduc->company_loan; ?></td>
															<td><?php echo $deduc->hdmf_loan; ?></td>          
															<td><?php echo $deduc->hmo_dep; ?></td>
															<td><?php echo $deduc->sss_salary_loan; ?></td>
															<td><?php echo $deduc->telephone_charges; ?></td>
															<td><?php echo $deduc->cash_advance; ?></td>
															<td><a href="{{ url('/admin/deductions/' . $deduc->ID . '/edit') }}">Edit</a> | <a href="{{ url('/admin/deductions/delete/' . $deduc->ID) }}">Delete</a></td>                                                
														</tr>				
									      <?php		} ?>
													</tbody>
												</table>
										  <?php		} else {?>
														<tr><td colspan="10">No deductions recorded.</td></tr>
													</tbody>
												</table>
