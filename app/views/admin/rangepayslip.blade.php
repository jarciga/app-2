...
<!--div class="page-container"-->
        ...
        <!--div class="row" style="padding-bottom:20px;"-->
          ...
          <div id="content" class="col-md-12" role="main">
            ...
            <h1 class="page-header">Choose the cut-off period to view payslip</h1>
 
			{{ Form::open(array('url' => '/employee/report/payslip')) }}
			
				{{ Form::label('Cut-Off Period:', 'Cut-Off Period:') }}
				
			<?php 
				if(!empty($timesheetArr) && count($timesheetArr) >= 2)
				{ ?>
					{{-- Form::select('payslipdate', array_merge(['' => '--- Please Select Cut-Off Date ---'], $timesheets), null, array('id' => '', 'class' => 'form-control2')) --}}
					
					{{ Form::select('payslipdate', $timesheetArr, 0, array('id' => '', 'class' => 'form-control2')) }}
					<br>
					{{ Form::submit('Generate Payroll Register', array('class' => 'btn btn-primary')) }}
		<?php	} else { ?>
					{{ Form::select('payslipdate', ['No Payslips Available'], '', array('id' => '', 'class' => 'form-control2'))}}	
					<br>
					{{ Form::submit('Generate Payroll Register', array('class' => 'btn btn-primary', 'disabled' => 'disabled')) }}
		<?php	} ?>
