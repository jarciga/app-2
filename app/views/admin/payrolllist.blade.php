...
<!--div class="page-container"-->
        ...
        <!--div class="row" style="padding-bottom:20px;"-->
          ...
          <div id="content" class="col-md-12" role="main">
            ...
            <h1 class="page-header">Payroll List</h1><br>
		...
		<?php   } ?>		
	        	...
	        	<div class="table-responsive">
					...
					<table class="table table-striped table-hover display table-list" cellspacing="0" width="100%">
						...
						<tbody>
							{{ Form::open(array('url' => '/admin/payroll/computation', 'id' => 'timeClockingForm', 'class' => 'form-horizontal')) }}
							<?php
									...
									foreach($getpays as $gpay)
									{
										if(!is_array($gpay) && !empty($gpay))
										{
											...
											<tr>
												...
												<td><?php echo $gpay->cutoff_starting_date . ' to ' . $gpay->cutoff_ending_date; ?></td>
											</tr>
							<?php   	} 
										else
										{
							...
							?>
									...
									<tr>
										<td colspan="8">{{ Form::submit('Process Payroll', array('class' => '', 'class' => 'btn btn-primary')) }}</td>
									</tr>
