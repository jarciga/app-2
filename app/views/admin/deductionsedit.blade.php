...
<!--div class="page-container"-->
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" style="font-size:14px; font-weight:bold;">Add New Employee Deduction</div>
          <div class="panel-body">
            ...
            {{ Form::open(array('url' => '/admin/deductions/' . $deductionEditInfo-> ID . '/edit', 'id' => 'timeClockingForm', 'class' => 'form-horizontal')) }}                
			...
			<div class="form-group">
                ...
                <div class="col-sm-3">
                {{ Form::text('cutfrom', $deductionEditInfo->cutfrom, array('class' => 'datepicker')) }}
                </div>
            </div>    
			...
			<div class="form-group">
                ...
                <div class="col-sm-3">
                {{ Form::text('cutto', $deductionEditInfo->cutto, array('class' => 'datepicker')) }}
                </div>	
			</div> 
            
            <br><br>
            <div class="form-group">
                {{ Form::label('cash_advance', 'Cash Advance', array('class' => 'col-sm-2 control-label')) }}           
                <div class="col-sm-3">
                {{ Form::text('cash_advance', $deductionEditInfo->cash_advance, array('id' => '', 'class' => 'form-control', 'placeholder' => 'Cash Advance')) }}
                </div>
            </div>            

			
            <div class="form-group">           
                {{ Form::label('company_loan', 'Company Loan', array('class' => 'col-sm-2 control-label')) }}
                <div class="col-sm-3">            
                {{ Form::text('company_loan', $deductionEditInfo->company_loan, array('id' => '', 'class' => 'form-control', 'placeholder' => 'Company Loan')) }}            
                </div>                        
            </div>            

			
            <div class="form-group">           
                {{ Form::label('hdmf_loan', 'HDMF Loan', array('class' => 'col-sm-2 control-label')) }}            
                <div class="col-sm-3">            
                {{ Form::text('hdmf_loan', $deductionEditInfo->hdmf_loan, array('id' => '', 'class' => 'form-control', 'placeholder' => 'HDMF Loan')) }}            
                </div>            
            </div>            
          
            
            <div class="form-group">           
                {{ Form::label('hmo_dep', 'HMO Deposit', array('class' => 'col-sm-2 control-label')) }}
                <div class="col-sm-3">            
                {{ Form::text('hmo_dep', $deductionEditInfo->hmo_dep, array('id' => '', 'class' => 'form-control', 'placeholder' => 'HMO Deposit')) }}            
                </div>                        
            </div>            
            
			
            <div class="form-group">           
                {{ Form::label('sss_salary_loan', 'SSS Salary Loan', array('class' => 'col-sm-2 control-label')) }}
                <div class="col-sm-3">           
                {{ Form::text('sss_salary_loan', $deductionEditInfo->sss_salary_loan, array('id' => '', 'class' => 'form-control', 'placeholder' => 'SSS Salary Loan')) }}            
                </div>                        
            </div>                  

			
            <div class="form-group">           
                {{ Form::label('telephone_charges', 'Telephone Charges', array('class' => 'col-sm-2 control-label')) }}
                <div class="col-sm-3">           
                {{ Form::text('telephone_charges', $deductionEditInfo->telephone_charges, array('id' => '', 'class' => 'form-control', 'placeholder' => 'Telephone Charges')) }}            
                </div>                        
            </div>                                             

            <div class="col-sm-offset-2 col-sm-10">
                <div class="col-sm-3">                        
                {{ Form::submit('Update Deductions', array('class' => '', 'class' => 'btn btn-primary')) }}
                </div>                                        
            </div>            
